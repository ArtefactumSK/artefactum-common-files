...
function artefactum_render_dashboard_widget() {
    ...
    /* Zmena DAY_IN_SECONDS na:
    7 * DAY_IN_SECONDS = 7 dní
    3 * DAY_IN_SECONDS = 3 dni
    12 * HOUR_IN_SECONDS = 12 hodín
    WEEK_IN_SECONDS = 1 týždeň 
    */
    
    if ($dismissed_time && (time() - $dismissed_time < 12 * HOUR_IN_SECONDS)) {
        ?>
